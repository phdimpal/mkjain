...
<?php echo $this->Form->create($registration, ['type' => 'file','id'=>'registratiomForm']); ?>
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title">Registration Edit </h3>
			</div>
					...
					<div class="row">
							<div class="col-md-12 pad">
								  ...
								  <div class="col-md-4">
										...
										<?php
										$option[$registration->master_role->role_name]= $registration->master_role->role_name; 
										echo $this->Form->input('jh', ['empty'=> '--Select--','data-placeholder'=>'Select role','label' => false,'class'=>'form-control select2','options'=>$option,'style'=>'width:100%;','value'=>$registration->master_role->role_name]);
										?>
										</div>
									</div>
								   ...
								   <div class="col-md-4">
										<div class="form-group">
											<label class="control-label"> </label>
												<?php
												if(!empty($registration->profile_pic)){
												echo $this->Html->image($registration->profile_pic, ['style'=>'width:100px; height:100px;']);
												}
												?>
										</div>
									</div>
		...
		<?php  $js=" 
			...
			$(document).ready(function(){ 
				 var state_id= $('select[name=master_class_id]').val();
					...
					$.ajax({ 
						...
						$('select[name=master_section_id]').val(".$registration->master_class_id.");
					}); 
