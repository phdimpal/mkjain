...
<div class="complains view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $complain->has('master_class') ? $this->Html->link($complain->master_class->class_name, ['controller' => 'MasterClasses', 'action' => 'view', $complain->master_class->id]) : '' ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><?= $complain->has('master_role') ? $this->Html->link($complain->master_role->role_name, ['controller' => 'MasterRoles', 'action' => 'view', $complain->master_role->id]) : '' ?></td>
        </tr>
        <tr>
    ...
    <div class="row">
        <h4><?= __('Query Reason') ?></h4>
        <?= $this->Text->autoParagraph(h($complain->query_reason)); ?>
    </div>
</div>
