...
class LeavesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reason' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'approved_by' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'approved_date' => ['type' => 'date', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'registration_id' => 1,
                'no_of_days' => 1,
                'created_on' => 1540456104,
                'updated_on' => 1540456104,
                'approved_by' => 1,
                'approved_date' => '2018-10-25',
                'is_deleted' => 1
            ],
        ];
        parent::init();
